...
class HttpUserAgent(StrEnum):
    ANDROID_FIREFOX = "Mozilla/5.0 (Android 10; Mobile; rv:89.0) Gecko/89.0 Firefox/89.0"
    ...
    LINUX_FIREFOX = "Mozilla/5.0 (X11; Linux i686; rv:114.0) Gecko/20100101 Firefox/114.0"
